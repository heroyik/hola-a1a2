...
| [vol12toc.json](file:///Users/ikyoon/proj/book/vol12toc.json) | **¡Hola, español! 1 & 2** 목차 | 1권: 초급1 (11과) / 2권: 초급2 (9과) <br> ![Vol 1](/Users/ikyoon/.gemini/antigravity/brain/84912891-8ef0-40e8-96cc-fc0207ae3cee/vol1_cover.jpg) ![Vol 2](/Users/ikyoon/.gemini/antigravity/brain/84912891-8ef0-40e8-96cc-fc0207ae3cee/vol2_cover.jpg) |
...
- **2.3.3.2 어휘 이미지 스타일**: **일본 애니메이션 스타일(Modern Anime Style)**을 채택하여 학습자의 흥미를 유발하되, 전체적인 컬러톤은 스페인 테마에 맞춤. 해당 섹션에서 다루는 어휘가 100% 이미지에 반영되도록 구성해야 함 (어휘와 삽화의 완전한 일치 필수).
...
2.  **도구**: `scripts/verify_grammar.js` (Playwright Engine)
3.  **검증 항목**:
    -   **구조 검증**: 11개 섹션의 존재 및 순서, 섹션명 명명 규칙 준수 여부.
