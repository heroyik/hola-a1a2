...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "a2_textbook.html")
COVER_IMG = "../bookcovers/bookcover2a2.png"
...
<head>
    ...
    <title>Hola-AL Nivel A2</title>
    {CSS}
</head>
<body>
<div class="container">
    <img src="{COVER_IMG}" alt="Cover A2" class="cover-image">
"""

# Read TOC and add hyperlinks
with open(os.path.join(PROJECT_ROOT, "chapters", "00_toc_a2.md"), "r") as f:
    toc_md = f.read()
...
grammar_md_path = os.path.join(PROJECT_ROOT, "chapters", "01_grammar_analysis_a2.md")
...
chapter_files = sorted(glob.glob(os.path.join(PROJECT_ROOT, "chapters", "ch*_a2_*.md")))
