...
<table style="width: 100%; border-collapse: collapse; border: 1px solid #ddd; text-align: left;">
  ...
  <tbody>
    ...
    <tr><td style="padding: 10px; border: 1px solid #ddd;"><strong>Pedro:</strong> Ya lo he hecho, pero sigue igual.</td><td style="padding: 10px; border: 1px solid #ddd;"><strong>페드로:</strong> 이미 해봤는데, 여전해요.</td></tr>
